...
class Config(object):
    def __init__(self):
        ...
        targetGroup.add_argument('-u', '--username', type=str, help='set modes username(only one)', default="LTDEND")
        ...
        configGroup.add_argument('--debug', action="store_true", help='enable debug mode', default=False)
